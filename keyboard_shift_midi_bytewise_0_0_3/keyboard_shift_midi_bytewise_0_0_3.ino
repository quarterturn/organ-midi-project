...
//  synth.setTVFResonance(channel, resonance);
//  synth.setTVFCutoff(channel, cutoff);
//  synth.setEnvAttack(channel, attack);
//  synth.setPortamento(channel, 1);
//  synth.setSpecialSynthControl(channel, 0x7e, 0x7f);

  // configure the voices for testing
